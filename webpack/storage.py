...
class WebpackHashStorage(StaticFilesStorage):
    ...
    def check_assets(self):
        """
        Throws an exception if assets fil eis not configured or cannot be found.
    ...
    def url(self, name):
        ...
        :return: url using the filename found in the assets.json file generated by webpack, if the name is not
            present in the json file, then the call is delegated to the super class without modifications.
        """
